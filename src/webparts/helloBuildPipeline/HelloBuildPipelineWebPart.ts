...
export default class HelloBuildPipelineWebPart extends BaseClientSideWebPart<IHelloBuildPipelineWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IHelloBuildPipelineProps> = React.createElement(
      HelloBuildPipeline,
      {
